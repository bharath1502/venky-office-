...
public interface RestPaymentService {
  ...
  public GetTransactionResponse getTransaction(String merchantId,
                                               ...
                                               String authId,
                                               String cardNum,
                                               String invoiceNum) throws ChatakPayException;
  ...
  public TransactionResponse processPopupVoidOrRefund(TransactionRequest transactionRequest) throws ChatakAdminException;
