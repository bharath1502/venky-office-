...
*
* Copyright (c) 2015 Girmiti Software
			...
			function setHeadersCss(table) {
				...
				c.$headers.not('.sorter-false').each(function(){
					var $this = $(this),
						...
						if($this.hasClass(ts.css.sortAsc)){
						    $('th').removeClass("image-append-down");
		                    $(this).addClass("image-append-up");
		                }else if($this.hasClass(ts.css.sortDesc)){
						    $('th').removeClass("image-append-up");
		                    $(this).addClass("image-append-down");
		                }
