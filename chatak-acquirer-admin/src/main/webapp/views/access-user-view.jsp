											...
											<div class="field-element-row">
												...
												<fieldset class="col-sm-3">
													...
													<form:input path="firstName" id="firstName"
														cssClass="form-control" readonly="true" onblur="this.value=this.value.trim();validFirstName()"
														maxlength="30" />
												...
												<fieldset class="col-sm-3">
													...
													<form:input path="lastName" id="lastName"
														cssClass="form-control" readonly="true" onblur="this.value=this.value.trim();validLastName()"
														maxlength="30" />
												...
												<fieldset class="col-sm-3">
													...
													<form:input path="phone" id="phone" cssClass="form-control" readonly="true"
										...
										<div class="col-sm-12 form-action-buttons">
											...
											<div class="col-sm-7">
												 <input
													...
													value='<spring:message code="common.label.cancel"/>' onclick="cancelAccessUserEdit()">
											</div>
										</div>
