			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="breadCrumb">
						<span class="breadcrumb-text"><spring:message code="accounts-manual-debit.label.adjustments"/></span>
						<span class="glyphicon glyphicon-play icon-font-size"></span>
						<span class="breadcrumb-text"><spring:message code="accounts-manual-debit.label.manualdebit"/></span>
					</div>
					<div class="tab-header-container active-background" style="margin-left: 44px;">
						<a href="#"><spring:message code="accounts-manual-debit.label.manualdebit"/></a>
					</div>
					<!-- Tab Buttons End -->
					<!-- Content Block Start -->
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<form:hidden id="timeZoneRegion" path="timeZoneRegion"/>
											...
											<div class="field-element-row">
												<fieldset class="col-sm-12" id="hideMerchantCode">
													<fieldset class="col-sm-3">
														<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="accounts-manual-debit.label.merchantorsubmerchantcode"/><span class="required-field">*</span></label>
													...
													<div class="col-sm-12 form-action-buttons" id="hideSearchButton">
														...
														<div class="col-sm-7">
															...
															<input type="button" class="form-control button pull-right close-fetch-details" onclick="resetValues()" value='<spring:message code="accounts-manual-credit.label.resetbutton"/>' ><!-- onClick="return resetPreAuthFetch()" -->
														</div>
													</div>
												...
												<fieldset class="col-sm-12 fetch-details" style="display: none;">
													...
													<fieldset class="col-sm-3">
														<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="accounts-manual-debit.label.debitamount"/><span class="required-field">*</span></label>
									...
									<div id="responseDiv">
										<c:if test="${debitResponse.errorCode eq 00}">
											<br>
											<table>
											<tr>
													<td><span class="black-text" style="font-size: initial;">&nbsp;<spring:message code="accounts-manual-debit.label.debitedsuccessfully"/></span></td>
											...
											<div class="col-sm-12 form-action-buttons">
												<div class="col-sm-5"></div>
												<div class="col-sm-7">
													<a class="form-control button pull-right" href="accounts-manual-debit"><spring:message code="reports.label.backbutton"/></a>
												</div>
											</div>
