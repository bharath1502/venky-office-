					...
					<div class="main-content-holder">
						<div class="row">
							<div class="col-sm-12">
								...
								<!-- Page Form Start -->
								<form:form action="bank-create" commandName="bank" name="bank" method="post">
									<div class="col-sm-12">
										<div class="row">
											<div class="field-element-row">
												...
												<fieldset class="col-sm-3">
													...
													<fieldset class="col-sm-3">
														...
														<form:select cssClass="form-control" path="currencyCodeAlpha"
															id="currencyCodeAlpha" onblur="return validateCurrency()" >
															<form:option value="">..:<spring:message code="reports.option.select"/>:..</form:option>
										...
										<div class="col-sm-12 form-action-buttons">
											...
											<div class="col-sm-7">
												<input type="submit" class="form-control button pull-right"
													value='<spring:message code="common.label.create"/>' onclick="return validCreateBank()"> <input
