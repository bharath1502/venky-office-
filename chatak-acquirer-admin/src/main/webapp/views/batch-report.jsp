					...
					<div class="main-content-holder">
						<div class="row">
							<div class="col-sm-12">
								...
								<form:form action="batch-report" name="resubmitForm" method="get"></form:form>
								<form:form action="get-batch-transaction-report" name="downloadReport" method="post">
						...
						<table id="serviceResults"
								...
								<thead>
									<tr>
										...
										<th style="width: 50px;"><spring:message code="accounts-manual-credit.label.merchantorsubmerchantcode"/></th>
										...
										<th style="width: 50px;"><spring:message code="reports.label.transactions.description"/></th>
										<th style="width: 40px;"><spring:message code="currency-search-page.label.currencycode"/></th>
										<th style="width: 40px;"><spring:message code="reports.label.transactions.amount"/></th>
							...
							<c:otherwise>
								<c:choose>
									<c:when test="${transactionReqObject.toGetCurrentDayTxns == true}">
										<tr><td colspan="10" style="color: red;"><spring:message code="reports.label.transactions.notransactionsfoundfortheday" /></td></tr>
									</c:when>
									<c:otherwise>
										<tr><td colspan="10" style="color: red;"><spring:message code="reports.label.transactions.notransactionsfound" /></td></tr>
									</c:otherwise>
								</c:choose>
							</c:otherwise>
						</c:choose>
