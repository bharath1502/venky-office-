										...
										<div class="row">
											<div class="field-element-row">
												<fieldset class="col-sm-3">
													...
													<form:input path="publicKeyName" id="publicKeyName" readonly="true"
												...
												<fieldset class="col-sm-3">
													...
													<form:input path="rid" id="rID" cssClass="form-control" readonly="true"
												...
												<fieldset class="col-sm-5">
													<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="ca.public.label.modulus"/><span
														class="required-field">*</span></label>
													<form:textarea path="publicKeyModulus" id="publicKeyModulus" readonly="true"
														cssClass="form-control" onblur="this.value=this.value.trim();validCAPublicKeyModulus()"/>
												...
												<fieldset class="col-sm-3">
													<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="ca.public.label.exponent"/><span
														class="required-field">*</span></label>
													<form:input path="publicKeyExponent" id="publicKeyExponent" readonly="true"
														cssClass="form-control" onblur="this.value=this.value.trim();validCAPublicKeyExponent()"
														maxlength="6" />
												...
												<fieldset class="col-sm-3">
													<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="ca.public.label.index"/><span
														class="required-field">*</span></label>
													<form:input path="publicKeyIndex" id="index" cssClass="form-control" readonly="true"
														onblur="this.value=this.value.trim();validIndex()" maxlength="2" />
										...
										<div class="col-sm-12 form-action-buttons">
											...
											<div class="col-sm-7">
												<input type="button" class="form-control button pull-right"
													value='<spring:message code="common.label.cancel"/>' onclick="resetCAPublicKeysSearch()">
											</div>
										</div>
