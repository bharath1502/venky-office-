										...
										<div class="row">
											<div class="field-element-row">
												...
												<fieldset class="col-sm-3">
													...
													<form:input cssClass="form-control" path="percentageOfTxn" onkeypress="return amountValidate(this,event)" onblur="return clientValidation('percentageOfTxn', 'amount','percentageOfTxnErrorDiv');"/>
													<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
												...
												<fieldset class="col-sm-3">
													...
													<form:input cssClass="form-control" path="flatFee" onkeypress="return amountValidate(this,event)" onblur="return clientValidation('flatFee', 'amount','flatFeeErrorDiv');" />
													<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
