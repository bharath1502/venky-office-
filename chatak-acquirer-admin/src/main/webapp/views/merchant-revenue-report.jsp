			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="breadCrumb">
						...
						<span class="breadcrumb-text"><spring:message code="admin.label.merchantrevenue" /></span>
					</div>
					<!-- Breadcrumb End -->
					<!-- Tab Buttons Start -->
					<!-- Tab Buttons End -->
					...
					<div class="main-content-holder">
						...
						<form:form action="downloadMerchantRevenueReport" name="downloadReport" method="post">
						...
						<form:form action="processMerchantRevenueReport" modelAttribute="feeReportRequest" method="post">
						<input type="hidden" name="CSRFToken" value="${tokenval}">
											...
											<div class="col-sm-7">
													...
													<a type="button" href="showMerchantRevenueReport" class="form-control button pull-right"><spring:message code="accounts-manual-credit.label.resetbutton" /></a>
											</div>
										</div>
								</form:form>
						</div>
							...
							<table id="serviceResults" class="table table-striped table-bordered table-responsive table-condensed tablesorter">
								<thead>
									<tr>
										...
										<th><spring:message code="admin.label.merchantamount"/></th>
