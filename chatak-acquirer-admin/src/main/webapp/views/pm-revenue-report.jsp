...
<body>
			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="breadCrumb">
						...
						<span class="breadcrumb-text"><spring:message code="admin.label.pmrevenue" /></span>
					</div>
					<!-- Breadcrumb End -->
					<!-- Tab Buttons Start -->
					<!-- Tab Buttons End -->
					...
					<!-- <div class="col-sm-12"> -->
						...
						<form:form action="showGlobalPendingTransactionReport" name="showGlobalPendingTransactionReport">
							...
							<form:form action="processISOTxns" name="showISOFeeReport"
								...
								<form:form action="getAllMatchedTxnsByEntityId" name="getAllMatchedTxnsByEntityId"
								method="post">
								<input type="hidden" id="issuanceSettlementEntityId" name="issuanceSettlementEntityId" />
						...
						<form:form action="processPmRevenueReport" modelAttribute="feeReportRequest" method="post">
						<input type="hidden" name="CSRFToken" value="${tokenval}">
											...
											<div class="col-sm-7">
													...
													<a type="button" href="showPmRevenueReport" class="form-control button pull-right"><spring:message code="accounts-manual-credit.label.resetbutton" /></a>
											</div>
										</div>
								</form:form>
						</div>
							...
							<table id="serviceResults" class="table table-striped table-bordered table-responsive table-condensed tablesorter">
								<thead>
									<tr>
										...
										<th><spring:message code="admin.label.pmamount"/></th>
	...
	function showAllTxnsForPM(issuanceSettlementEntityId, pmRevenue) {
		get('issuanceSettlementEntityId').value = issuanceSettlementEntityId;
		get('getModelView').value = pmRevenue;
