											...
											<section class="field-element-row account-details-content" style="display:none;">
												<fieldset class="col-sm-12">
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="resellerName"
															...
															onblur="validateResellerName()" readonly="true"/>
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="accountNumber"
															...
															readonly="true"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
															<span id="accountNumberEr" class="red-error">&nbsp;</span>
														</div>
													</fieldset>
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="accountBalance"
															id="accountBalance" maxlength="50"
															readonly="true"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
															<span id="accountBalanceEr" class="red-error">&nbsp;</span>
														</div>
													</fieldset>
													<fieldset class="col-sm-3">
												...
												<div class="col-sm-12 button-content">
													<fieldset class="col-sm-7 pull-right">
														<input type="submit" value='<spring:message code="common.label.update"/>'
															class="form-control button pull-right update-reseller"
															> 
														<input type="button"
															class="form-control button pull-right marginL10"
															value='<spring:message code="common.label.cancel"/>' onclick="cancelEditReseller()">
													</fieldset>
												</div>
									</section>		
									</div>	
...
<script src="../js/utils.js"></script>
	...
	<script>
		...
		$('.update-reseller').click(function() {
			if(!validateUpdateReseller())
			{
				return false;
			}
