	...
	<div id="wrapper">
		...
		<div class="container-fluid">
			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="breadCrumb">
						<span class="breadcrumb-text">Reports</span> <span
							...
							class="breadcrumb-text">Specific User Reports</span><span
							class="glyphicon glyphicon-play icon-font-size"></span> <span
							class="breadcrumb-text">EFT Transfer</span>
					</div>
					<!-- Breadcrumb End -->
					<!-- Tab Buttons Start -->
					...
					<div class="col-sm-12">
						...
						<form:form action="downloadSpecificEFTTransferReport" name="downloadReport" method="post">
						...
						<form:form action="processSpecificEFTTransfers" name="processSpecificEFTTransfers">
						...
						<div class="search-results-table table-scroll" id="checkb" style="display: none;padding-top: 10px;">
				...
				<div id="my_popup" class="locatioin-list-popup" style="display: none;width: 880px;">
