				...
				<div class="col-xs-12 content-wrapper">
					...
					<div class="breadCrumb">
						<span class="breadcrumb-text">Reports</span> <span
							...
							class="breadcrumb-text">Statement</span>
					</div>
					<!-- Breadcrumb End -->
					<!-- Tab Buttons Start -->
					...
					<div class="search-results-table table-scroll">
						<!-- <table class="table table-striped table-bordered table-condensed" style="margin-bottom: 0px;">
							...
							<thead>
							<tr>
								<th style="width: 165px;">User Name</th>
								<th style="width: 214px;">Company Name</th>
								<th style="width: 155px;">First Name</th>
								<th style="width: 155px;">Last Name</th>
								<th style="width: 163px;">Creation Date</th>
								...
								<c:when test="${!(fn:length(merchants) eq 0) }">
									<c:forEach items="${merchants}" var="merchantData">
										<tr>
											...
											<td><a style="text-decoration: underline;" href="javascript:getStatementAccountDetails('${merchantData.id}','${merchantData.merchantCode}')">${merchantData.userName}</a></td>
											<td>${merchantData.businessName }</td>
