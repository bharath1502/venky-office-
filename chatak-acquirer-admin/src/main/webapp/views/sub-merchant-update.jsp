												...
												<fieldset class="col-sm-12">
													...
													<%-- <fieldset class="col-sm-3">
														...
														<form:select cssClass="form-control" path="status"
															...
															<form:option value="5">
																<spring:message code="manage.option.sub-merchant.self-registered-pending" />
															</form:option>
														</form:select>
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="partnerName"
															id="partnerId" readonly="true" />
														<div class="discriptionErrorMsg" data-toggle="tooltip"
															data-placement="top" title="">
															<span id="partnerNameEr" class="red-error">&nbsp;</span>
														</div>
													</fieldset>
												</fieldset>
												...
												<fieldset class="col-sm-12">
													...
													<fieldset class="col-sm-3">
														...
														<fmt:formatNumber type="currency" value="${merchant.legalAnnualCard}" pattern="<%=Constants.AMOUNT_FORMAT%>" var="legalAnnualCard" />
															<input name="legalAnnualCard" id="legalAnnualCard" maxlength="12" value="${ legalAnnualCard}" onblur="this.value=this.value.trim();appendDollarSymbol();return clientValidation('legalAnnualCard', 'dollar_amount','legalAnnualCardErrorDiv');"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="legalPin"
															id="legalPin" onkeypress="generalZipCode()" maxlength="7"
															onblur="this.value=this.value.trim();return zipCodeNotEmpty(id)" />
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
