			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="tab-header-container-first">
						<a href="switch-search"><spring:message code="common.label.search"/>
						</a>
					</div>
					</c:if>
												...
												<div class="col-sm-12 button-content">
													<fieldset class="col-sm-7 pull-right">
														<input type="submit"
															...
															value='<spring:message code="common.label.create"/>' onclick="return validateCreateSwitch()"> <input type="button"
															class="form-control button pull-right marginL10"
															value='<spring:message code="common.label.reset"/>' onclick="resetSwitchInfo()">  <input
															type="button"
															class="form-control button pull-right marginL10"
