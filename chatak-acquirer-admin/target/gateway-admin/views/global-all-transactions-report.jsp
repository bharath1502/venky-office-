			...
			<article>
				<div class="col-xs-12 content-wrapper">
					...
					<div class="col-sm-12">
						...
						<form:form action="downloadAllTransactionsReport" name="downloadReport" method="post">
						...
						<div class="search-results-table table-scroll" id="checkb" style="display: none;">
							...
							<table id="serviceResults" class="table table-striped table-bordered table-responsive table-condensed tablesorter">
								...
								<c:choose>
									<c:when
										test="${!(fn:length(allTransactionsReportList) eq 0) }">
										<c:forEach items="${allTransactionsReportList}" var="transaction">
									...
									<c:otherwise>
										<tr>
											<td colspan="12" style="color: red;">No Transactions
												Found</td>
										</tr>
									</c:otherwise>
								</c:choose>
								...
								<c:if test="${ !(fn:length(allTransactionsReportList) eq 0)}">
