...
<html lang="en">
<head>
<title>Pending Merchant Show Remaining</title>
<meta charset="utf-8">
...
<section class="field-element-row account-details-content"
												...
												<fieldset class="col-sm-12">
													...
													<fieldset class="col-sm-3">
														<label data-toggle="tooltip" data-placement="top" title=""><spring:message code="pending-merchant-show-remaining.label.fax"/></label>
