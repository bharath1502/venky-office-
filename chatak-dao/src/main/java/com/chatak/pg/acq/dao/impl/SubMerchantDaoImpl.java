...
public class SubMerchantDaoImpl extends MerchantDaoImpl implements SubMerchantDao {
  ...
  public GetMerchantListResponse getSubMerchantList(GetMerchantListRequest searchMerchant) {
    ...
    try {
	 ...
	 subMerchantParam.setParameter("City", !"".equals(searchMerchant.getCity()) ? searchMerchant.getCity() : null);
		subMerchantParam.setParameter("Country", !"".equals(searchMerchant.getCountry()) ? searchMerchant.getCountry() : null);
	 subMerchantParam.setParameter("Email", !"".equals(searchMerchant.getEmailId()) ? searchMerchant.getEmailId() : null);
		subMerchantParam.setParameter("subMerchantCode", !"".equals(searchMerchant.getSubMerchantCode()) ? searchMerchant.getSubMerchantCode() :  null);
	 subMerchantParam.setParameter("status", searchMerchant.getStatus() != null ? searchMerchant.getStatus() : null);
	 subMerchantParam.setParameter("isoName", !"".equals(searchMerchant.getIsoName()) ? searchMerchant.getIsoName() : null);
		...
		while (it.hasNext()) {
			try {
				...
				if(merchantRequest.getEntityType().equals(PGConstants.PROGRAM_MANAGER_NAME)){
					merchantRequest.setEntityName(subMerchantsProgramManagerName(obj));
				}else {
					merchantRequest.setEntityName(subMerchantsIsoName(obj));
				}
	...
	protected Integer getTotalSubMerchants(GetMerchantListRequest searchMerchant) {
	  ...
	  subMerchantSqlQuery.append(" and (:isoName is null or f.IsoName = :isoName) ");
		...
		subMerchantParam.setParameter("Country",
				!"".equals(searchMerchant.getCountry()) ? searchMerchant.getCountry() : null);
		subMerchantParam.setParameter("Email", !"".equals(searchMerchant.getEmailId()) ? searchMerchant.getEmailId() : null);
		subMerchantParam.setParameter("subMerchantCode",
				!"".equals(searchMerchant.getSubMerchantCode()) ? searchMerchant.getSubMerchantCode() : null);
		subMerchantParam.setParameter("status", searchMerchant.getStatus() != null ? searchMerchant.getStatus() : null);
		subMerchantParam.setParameter("isoName", !"".equals(searchMerchant.getIsoName()) ? searchMerchant.getIsoName() : null);
