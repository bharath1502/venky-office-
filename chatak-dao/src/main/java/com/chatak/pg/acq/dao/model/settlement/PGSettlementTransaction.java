 ...
 */
@Entity
@Table(name = "PG_ISS_SETTLEMENT_TXN")
public class PGSettlementTransaction implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	/*
	 * @SequenceGenerator(name = "SEQ_PG_ACCOUNT_TRANSACTIONS_ID", sequenceName
	 * = "SEQ_PG_ACCOUNT_TRANSACTIONS")
	 * 
