...
public class ActionCode {
  ...
  public static final String ERROR_CODE_0D = "0D";
  public static final String ERROR_CODE_1D = "1D";
  public static final String ERROR_CODE_2D = "2D";
  public static final String ERROR_CODE_3D = "3D";
  public static final String ERROR_CODE_4D = "4D";
  ...
  private static void initMessages()
  {
     ...
     mMessages.put(ERROR_CODE_0D, "Inactive partner");
     mMessages.put(ERROR_CODE_1D, "Card doesnot Linked with the Partner");
     mMessages.put(ERROR_CODE_2D, "INVALID_CARD_LENGTH");
     mMessages.put(ERROR_CODE_3D, "Currency Mismatch");
     mMessages.put(ERROR_CODE_4D, "Error in processing the data");
  }
