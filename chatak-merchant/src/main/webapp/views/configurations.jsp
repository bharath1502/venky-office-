												...
												<div class="col-sm-12 button-content">
													<fieldset class="col-sm-8 pull-right">
														<input type="button"
															...
															onclick="return validateCreateMerchantStep5()"> <input
															type="button"
														...
														<input type="button"
															class="form-control button pull-right marginL10"
															value="<spring:message code="search-sub-merchant.lable.reset"></spring:message>" onclick="resetConfigurationsInfo()">
													</fieldset>
												</div>
