				...
				<div class="">
					<div class="col-xs-12 content-wrapper">
						<div class="breadCrumb">
							<span class="breadcrumb-text"><spring:message code="fund-transfer-check.label.transfers"/></span> <span
									...
									<div class="col-sm-12 button-content" id="submitUpdate">
										<fieldset class="col-sm-7 pull-right">
											<input type="submit"
												...
												value="<spring:message code="fund-transfer-check.label.processbutton"/>">
											<div>
												<input type="button" class="form-control button pull-right"
													value="<spring:message code="fund-transfer-check.label.cancelbutton"/>" onclick="return backTodashBoard();">
											</div>
										<div>
										<a type="button"
								class="form-control button pull-right"
								href="fund-transfer-check"><spring:message code="fund-transfer-check.label.resetbutton"/></a></div>
										</fieldset>
									</div>
