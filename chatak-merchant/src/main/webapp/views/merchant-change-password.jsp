							...
							<input type="hidden" name="CSRFToken" value="${tokenval}">
								...
								<fieldset class="col-sm-5"></fieldset>
									...
									<span class="green-error"><span style="font-weight: bold;"><spring:message code="change-password.label.note"/></span><spring:message code="change-password.label.pwdmsg1"/>
										...
										<div class="input-group">
											...
											<input type="password" name="currentPassword" id="currentPassword" class="form-control" placeholder="<spring:message code="change-password.label.currentpassword"/>" onblur="validateCurrentPassword()"/>
										</div>
								...
								<div class="col-sm-4"></div>
									<div class="col-sm-2" style="margin-left: 80px;">
										<input type="button" class="form-control button login-main-button" value='<spring:message code="common.label.cancel"/>' onclick="cancelChangePassword()">
									</div>
									<div class="col-sm-2">
										<input type="submit" class="form-control button login-main-button" value='<spring:message code="common.label.submit"/>' onclick="return validSubmit()">
									</div>	
