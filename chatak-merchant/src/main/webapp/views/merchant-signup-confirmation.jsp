	...
	<fieldset class="col-sm-12 padding0">
		<fieldset class="col-sm-6">
			<fieldset class="fieldset merchant-content">
				<legend class="legend content-space">Basic Info</legend>
				<table class="confirm-info-table">
				<tr>
						<td>Primary Merchant Code:</td>
						<td><div id="confirmParentMerchantCode"></div></td>
					</tr>
					<tr>
						<td>Company Name:</td>
		...
		<fieldset class="col-sm-6">
			<fieldset class="fieldset merchant-content">
				<legend class="legend content-space">Bank Info</legend>
				<table class="confirm-info-table">
					<tr>
						<td>Name:</td>
		...
		<fieldset class="col-sm-6">
			<fieldset class="fieldset contact-content">
				<legend class="legend content-space">Additional Info</legend>
				<table class="confirm-info-table">
					<tr>
						<td>User Name:</td>
		...
		<fieldset class="col-sm-6">
			<fieldset class="fieldset merchant-content">
				<legend class="legend content-space">Legal Entity</legend>
				<table class="confirm-info-table">
					<tr>
					...
					<tr>
						<td>Expected Annual Card Sales:</td>
		...
		<fieldset class="col-sm-6">
			<fieldset class="fieldset merchant-content">
				<legend class="legend content-space">Legal Entity Representative</legend>
				<table class="confirm-info-table">
					<tr>
						<td>SSN:</td>
		...
		<fieldset class="col-sm-6">
			<fieldset class="fieldset bank-content">
				<legend class="legend content-space">Configurations</legend>
				<table class="confirm-info-table">
					<tr>
						<td>Auto settlement options:</td>
						<td><div id="confirmMautoSettlement"></div></td>
					</tr>
					<tr>
						<td>Auto Transfer Limit:</td>
