...
<title>Chatak Acquirer Merchant</title>
<!-- Bootstrap -->
					...
					<div class="main-content-holder padding0">
						...
						<div class="row margin0">
							<div class="col-sm-12">
								...
								<!--Success and Failure Message End-->
								<!-- Page Form Start -->
								<form:form action="create-recurring-customer"
									...
									<div class="col-sm-12 paddingT20">
										<div class="row">
											...
											<section class="field-element-row account-details-content">
												<fieldset class="col-sm-12">
													<fieldset class="col-sm-3">
														...
														<form:input path="firstName" cssClass="form-control"
															...
															onblur="return clientValidation('firstName', 'first_name','firstName_ErrorDiv');" onkeydown="validateSpace(this)"/>
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="lastName" path="lastName"
															...
															onblur="return clientValidation('lastName', 'last_name','lastName_ErrorDiv');" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="businessName"
															...
															onblur="validateBusinessName()" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="department" path="department" maxlength="50"
															cssClass="form-control"
															onblur="return clientValidation('department', 'department','department_ErrorDiv');" onkeydown="validateSpace(this)"/>
													    <div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="emailId" path="emailId" maxlength="100"
															cssClass="form-control"
															onblur="return validateUpdateEmailId();" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="mobileNumber" path="mobileNumber" maxlength="10"
															cssClass="form-control"
															onblur="return validateMobilePhone(mobileNumber);" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<br/>
													<fieldset class="col-sm-12">
                                                        <span><strong><spring:message code="recurring-search.label.mailingaddress"/></strong></span>
                                                      </fieldset>
													<fieldset class="col-sm-3">
														...
														<form:input id="address1" path="address1" maxlength="250"
															cssClass="form-control"
															onblur="return clientValidation('address1', 'address','address1_ErrorDiv');" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="address2" path="address2" cssClass="form-control" maxlength="250"
														onblur="return clientValidation('address2', 'address','address2_ErrorDiv');" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input path="address3" cssClass="form-control" maxlength="250" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="area" path="area" cssClass="form-control" maxlength="50"
															onblur="return clientValidation('area', 'area','area_ErrorDiv');" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:input id="city" path="city" cssClass="form-control" maxlength="20"
															onblur="return clientValidation('city', 'pcity','city_ErrorDiv');" onkeydown="validateSpace(this)"/>
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
													...
													<fieldset class="col-sm-3">
														...
														<form:select cssClass="form-control" path="state"
															id="state"
															onblur="return clientValidation('state', 'state','state_ErrorDiv');" onkeydown="validateSpace(this)">
															<form:option value="">..:<spring:message code="sub-merchant-create.label.select"/>:..</form:option>
												...
												<form:hidden path="recurringCustInfoId" />
												...
												<div class="col-sm-12 button-content">
													<fieldset class="col-sm-7 pull-right">
														<input type="submit"
															...
															value="<spring:message code="recurring-search.label.savecontinue"/>s"
															onclick="return validateRecurringCustmerUpdate()"> <input
															type="button" class="form-control button pull-right"
															value="<spring:message code="merchant-forgot-password.label.cancel"/>" onclick="return cancel()">
