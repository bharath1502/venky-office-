...
<body
	...
	<div
		...
		<h1>
			"
			<spring:message code="session-invalid.label.invalidaccessiontimeout" />
			"
		</h1>
		<a href="login"><spring:message
				code="access-invalid.label.pleaseclickheretogotoLoginpage" /></a>
	</div>
