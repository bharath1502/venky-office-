								...
								<form:form action="sub-merchant-update" commandName="merchant"
									...
									<div class="col-sm-12 paddingT20">
										<div class="row">
											...
											<section class="field-element-row account-details-content" style="display:none;">
												...
												<fieldset class="col-sm-3">
													...
													<fieldset class="col-sm-3">
														...
														<form:input cssClass="form-control" path="partnerId"
											...
											<section class="field-element-row bank-info-details-content" style="display:none;">
												...
												<div class="col-sm-12 button-content">
													<fieldset class="col-sm-7 pull-right">
														...
														<input type="button" class="form-control button pull-right marginL10" value="<spring:message code="sub-merchant-create.label.cancel"></spring:message>" onclick="openCancelConfirmationPopup()">
													</fieldset>
												</div>
												<!--Panel Action Button End -->
											</section>
											...
											<!--Panel Action Button Start -->
						      		   <jsp:include page="legal-entity-update.jsp"></jsp:include>												
											<!-- Free Transactions Content Start -->
												<!--Panel Action Button Start -->
									<jsp:include page="additional-information-update.jsp"></jsp:include>			
