...
<body oncontextmenu="disableRightClick(<%=StatusConstants.ALLOW_RIGHT_CLICK%>)">
			...
			<div class="col-xs-12 content-wrapper">
				...
				<div class="breadCrumb">
					<span class="breadcrumb-text"><spring:message code="virtual-terminal-sale.label.virtualterminal"/></span> <span
						...
						class="breadcrumb-text"><spring:message code="virtual-terminal-sale.label.voi"/></span>
				</div>
				<!-- Breadcrumb End -->
				<!-- Tab Buttons Start -->
				...
				<div class="tab-header-container active-background">
					<a href="#"><spring:message code="virtual-terminal-sale.label.void"/></a>
				</div>
				<div class="tab-header-container">
									...
									<div class="row">
										<div class="field-element-row">
											<fieldset class="col-sm-12">
												...
												<div class="col-sm-12" style="color:#1f497d;"><spring:message code="virtual-terminal-sale.label.pendingtransactions"/>!!</div>
											...
											<fieldset class="col-sm-12 fetch-content">
												...
												<div class="col-sm-12 form-action-buttons">
													<div class="col-sm-5"></div>
													<div class="col-sm-7">
														<input type="button" class="form-control button pull-right" value=<spring:message code="virtual-terminal-sale.label.continuebutton"/> onClick="return openConfirmPagePreLook()">
													</div>
												</div>
												<!--Panel Action Button End Merchant ID-->
											</fieldset>
										</div>
									</div>
								</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			if ("${virtualTeminalVoid.successDiv}" == "true") {
				$("#hideAllFields").hide();
			}
