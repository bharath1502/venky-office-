...
<section class="field-element-row legal-details-rep-content" style="display:none;">
												<fieldset class="col-sm-12">													
													...
													<legend></legend>
														...
														<form:input cssClass="form-control" path="legalAnnualCard"
															id="legalAnnualCard" maxlength="12" onblur="this.value=this.value.trim();appendDollarSymbol();return clientValidation('legalAnnualCard', 'dollar_amount','legalAnnualCardErrorDiv');" />
														<div class="discriptionErrorMsg" data-toggle="tooltip" data-placement="top" title="">
												...
												<div class="col-sm-12 button-content">
													...
													<legend></legend>
														...
														<input type="button"
															class="form-control button pull-right marginL10"
															value="<spring:message code="search-sub-merchant.lable.reset"></spring:message>" onclick="resetLegalEntityRepInfo()">
													</fieldset>
												</div>
