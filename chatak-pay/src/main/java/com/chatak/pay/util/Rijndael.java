...
public final class Rijndael {
  ...
  public byte[] encryptBlock(byte pt[], byte ct[]) {
    ...
    k += Constants.FIVE;
    int v = rek[k];
    ct[0] = (byte) (Se[t0 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    ct[1] = (byte) (Se[t1 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    ct[Constants.TWO] = (byte) (Se[t2 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    ct[Constants.THREE] = (byte) (Se[t3 & 0xff] ^ v);
    v = rek[k + 1];
    ct[Constants.FIVE] = (byte) (Se[t1 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    ct[Constants.FIVE] = (byte) (Se[t2 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    ct[Constants.SIX] = (byte) (Se[t3 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    ct[Constants.SEVEN] = (byte) (Se[t0 & 0xff] ^ v);
    v = rek[k + Constants.TWO];
    ct[Constants.EIGHT] = (byte) (Se[t2 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    ct[Constants.NINE] = (byte) (Se[t3 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    ct[Constants.TEN] = (byte) (Se[t0 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    ct[Constants.ELEVEN] = (byte) (Se[t1 & 0xff] ^ v);
    v = rek[k + Constants.THREE];
    ct[Constants.TWELVE] = (byte) (Se[t3 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    ct[Constants.THIRTEEN] = (byte) (Se[t0 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    ct[Constants.FOURTEEN] = (byte) (Se[t1 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
  ...
  public byte[] decryptBlock(byte ct[], byte pt[]) {
    ...
    k += Constants.FIVE;
    int v = rdk[k];
    pt[0] = (byte) (Sd[t0 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    pt[1] = (byte) (Sd[t3 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    pt[Constants.TWO] = (byte) (Sd[t2 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    pt[Constants.THREE] = (byte) (Sd[t1 & 0xff] ^ v);
    v = rdk[k + 1];
    pt[Constants.FIVE] = (byte) (Sd[t1 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    pt[Constants.FIVE] = (byte) (Sd[t0 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    pt[Constants.SIX] = (byte) (Sd[t3 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    pt[Constants.SEVEN] = (byte) (Sd[t2 & 0xff] ^ v);
    v = rdk[k + Constants.TWO];
    pt[Constants.EIGHT] = (byte) (Sd[t2 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    pt[Constants.NINE] = (byte) (Sd[t1 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    pt[Constants.TEN] = (byte) (Sd[t0 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
    pt[Constants.ELEVEN] = (byte) (Sd[t3 & 0xff] ^ v);
    v = rdk[k + Constants.THREE];
    pt[Constants.TWELVE] = (byte) (Sd[t3 >>> Constants.TWENTY_FOUR & 0xff] ^ v >>> Constants.TWENTY_FOUR & 0xff);
    pt[Constants.THIRTEEN] = (byte) (Sd[t2 >>> Constants.SIXTEEN & 0xff] ^ v >>> Constants.SIXTEEN & 0xff);
    pt[Constants.FOURTEEN] = (byte) (Sd[t1 >>> Constants.EIGHT & 0xff] ^ v >>> Constants.EIGHT & 0xff);
