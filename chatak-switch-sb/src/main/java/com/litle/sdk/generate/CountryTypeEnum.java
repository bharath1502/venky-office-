...
public enum CountryTypeEnum {
    ...
    private static Logger logger = Logger.getLogger(CountryTypeEnum.class);
  
    public String value() {
        return name();
    }
    public static CountryTypeEnum fromValue(String v) throws ChatakInvalidTransactionException{
        try {
          return valueOf(v);
        }
        catch(Exception e) {
          logger.error("ERROR:: CountryTypeEnum:: fromValue method", e);
         throw new ChatakInvalidTransactionException(ActionCode.ERROR_CODE_E3);
        }
    }
}